...
class ContentController extends BaseContentController
{
    ...
    public function classAction($contentDocument)
    {
        ...
        $params = [
            'cmfMainContent' => $contentDocument,
            'info' => 'This page is rendered by <code>'.__METHOD__.'</code>. This controller will be called for content objects that are instances of <code>App\Document\DemoClassContent</code>.',
        ];
